...
export default function DriverShow({ driver, deliveries, stats }) {
    return (
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="hidden text-sm text-gray-500 sm:block">
                            Delivery history and totals for this driver
                        </p>
                    </div>
                </div>
            }
                ...
                <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm sm:p-6">
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                        <div className="flex items-start gap-4">
                            <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-indigo-50 text-sm font-bold text-indigo-600">
                                {driver.name ? initials(driver.name) : PersonIcon}
                            </span>
                            <div>
                                <div className="flex flex-wrap items-center gap-2.5">
                                    ...
                                    <Badge
                                        label={driver.status}
                                        styles={statusStyles[driver.status] ?? statusStyles.inactive}
                                    />
                                </div>
                    ...
                    <dl className="mt-6 grid grid-cols-2 gap-x-6 gap-y-4 border-t border-gray-100 pt-5 sm:grid-cols-3 lg:grid-cols-5">
                        ...
                        <Field
                            ...
                            sub={driver.registrant_name ? `by ${driver.registrant_name}` : null}
                        />
                                        ...
                                        <td colSpan={7} className="px-6 py-14 text-center">
                                            <div className="mx-auto flex max-w-sm flex-col items-center">
                                                ...
                                                <p className="mt-1 text-sm text-gray-400">
                                                    Deliveries logged with this driver will appear here.
                                                </p>
                                                <Link
